rm(list=ls())
library(readr)
setwd("C:/Users/jkbro/STA 486C/NOT-Project-1-STA486C/data-raw")
NYPD_Arrest <- read_csv("NYPD_Arrest_Data_2023.csv")
...
setwd("C:/Users/jkbro/STA 486C/NOT-Project-1-STA486C/data")

save(NYPD_Arrest, file = "NYPD_Arrest.RData")
